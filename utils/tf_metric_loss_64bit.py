...
def triplet_semihard_loss_64bit(
    ...
    <tf.Tensor: shape=(), dtype=float64, numpy=2.4142137>
    ...
    if distance_metric == "L2":
        pdist_matrix = pairwise_distance_64bit(
...
@tf.keras.utils.register_keras_serializable(package="Addons")
class TripletSemiHardLoss_64bit(LossFunctionWrapper):
...
@tf.keras.utils.register_keras_serializable(package="Addons")
class TripletHardLoss64bit(LossFunctionWrapper):
